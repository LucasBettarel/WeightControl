...
' Communication Module for the scale (RS232)
' More details : http://read.pudn.com/downloads179/sourcecode/windows/comm/834483/Gsm/modSerial.bas__.htm
...
Dim udtCommStat As COMSTAT
    ...
    With udtCommError
        ...
        .strErrorMessage = .strErrorMessage & "  COMM Error Flags = " & _
                Hex$(lngErrorFlags)
    '.strErrorMessage = "The weighting scale is not connected properly, please check?"
